...
export class ThreedRendererManager implements ThreedRenderer {
    ...
    public tick(threedSceneManager: ThreedSceneManager): void { 
        
    }

    public render(threedSceneManager: ThreedSceneManager): void {
