...
export const defaultThreedVectorSettings: ThreedVectorSettings = {
    x: 0,
    y: 0,
    z: 0
};
...
export const defaultThreedSceneSettings: ThreedSceneSettings = {
    threedScaleVectorSettings: defaultThreedVectorSettings,
    threedPositionVectorSettings: defaultThreedVectorSettings,
    threedRotationVectorSettings: defaultThreedVectorSettings,
};
